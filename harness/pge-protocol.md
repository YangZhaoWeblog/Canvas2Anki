...
> layer: profile
> 本文件负责 Planner / Generator / Evaluator 工作流；不替代 `AGENTS.md` 中的主工作流。
...
- parser, converter, exporter, metadata writeback, or AnkiConnect side-effect work;
...
4. user-data / API / metadata / dependency safety;
